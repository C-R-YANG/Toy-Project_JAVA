...
<div class="food_search_box">
    <div class="search flex">
        ...
        <div class="search_area">
            <span>지역</span>
            <button type="button" class="area_btn btn" onclick="showDropDown(this)">전체</button>
            <img class="search_dropdown_icon"src="${url}/resource/img/dropdown.png" alt="dropdown"/>
            <div class="area_dropdown_list none">
                ...
                <button class="area_apply_btn" onclick="hideDropDown(this)">적용</button>
            </div>
        </div>
        <div class="search_sort">
            <span>종류</span>
            <button type="button" class="sort_btn btn" onclick="showDropDown(this)">전체</button>
            <img class="search_dropdown_icon" src="${url}/resource/img/dropdown.png" alt="dropdown"/>
            <div class="sort_dropdown_list none">
                <div onclick="allCheck(this)">
                ...
                <button class="sort_apply_btn" onclick="hideDropDown(this)">적용</button>
            </div>
        </div>
        <div class="search_parking">
            <span>주차</span>
            <button type="button" class="parking_btn btn" onclick="showDropDown(this)">가능</button>
            <img class="search_dropdown_icon" src="${url}/resource/img/dropdown.png" alt="dropdown"/>
            <div class="parking_dropdown_list none">
                <div>
                    <input type="radio" id="possible" name="parking" checked="true"/>
                ...
                <button class="parking_apply_btn" onclick="hideDropDown(this)">적용</button>
            </div>
        </div>
        <div>
            <img class="search_reset_icon" src="${url}/resource/img/reset.png" alt="reset" onclick="refrestFilter()"/>
        </div>
    </div>
    ...
    <div class="content_wrap flex">
        <div class="content_list">
            ...
            <div class="content_bottom flex">
                <img class="content_bottom_icon" src="${url}/resource/img/eye.png"      alt="eye" />
                <p>500</p>
                <img class="content_bottom_icon" src="${url}/resource/img/favorite.png" alt="favorite" />
                <p>3</p>
                <img class="content_bottom_icon" src="${url}/resource/img/star.png"     alt="star" />
                <p>50</p>
            </div>
        </div>
